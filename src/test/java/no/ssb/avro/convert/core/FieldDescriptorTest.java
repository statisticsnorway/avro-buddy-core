...
class FieldDescriptorTest {
    ...
    @Test
    public void newField_givenPathString_shouldDeduceFieldName() {
    ...
    @Test
    public void newField_givenPathString_shouldNormalizePath() {
    ...
    @Test
    public void field_givenGlobExpression_shouldMatch() {
    ...
    @Test
    public void field_givenGlobExpression_shouldNotMatch() {
